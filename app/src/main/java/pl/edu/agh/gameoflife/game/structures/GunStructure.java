...
public class GunStructure extends AbstractStructure {
    ...
    public GunStructure(int x, int y, int width, int height) {
        ...
        if (x + 38 <= width && y + 8 < height) {
            listOfStructure.add(new SimpleCell(x, y + 4, 1));
            ...
            listOfStructure.add(new SimpleCell(x + 11, y + 1, 1));
            listOfStructure.add(new SimpleCell(x + 11, y + 5, 1));
            listOfStructure.add(new SimpleCell(x + 12, y, 1));
            ...
            listOfStructure.add(new SimpleCell(x + 16, y + 4, 1));
            ...
            listOfStructure.add(new SimpleCell(x + 21, y + 4, 1));
            listOfStructure.add(new SimpleCell(x + 21, y + 5, 1));
            listOfStructure.add(new SimpleCell(x + 21, y + 6, 1));
            listOfStructure.add(new SimpleCell(x + 22, y + 7, 1));
            listOfStructure.add(new SimpleCell(x + 22, y + 3, 1));
            listOfStructure.add(new SimpleCell(x + 24, y + 3, 1));
            ...
            listOfStructure.add(new SimpleCell(x + 35, y + 6, 1));
        }
    }
